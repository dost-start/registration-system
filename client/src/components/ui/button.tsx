  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        ...
        accent:
          "bg-accent text-accent-foreground shadow-xs hover:bg-accent/80 hover:cursor-pointer",
        primary:
          "bg-primary text-primary-foreground shadow-xs hover:bg-primary/90 focus-visible:ring-primary/20 dark:focus-visible:ring-primary/40 dark:bg-primary/60 hover:cursor-pointer",
        destructive:
        ...
        outlinePrimary:
          "border border-summit-blue bg-white text-summit-blue shadow-xs hover:bg-summit-blue/5 hover:text-summit-blue hover:cursor-pointer",
        outlineSecondary:
          "border border-summit-green bg-white text-summit-green shadow-xs hover:bg-summit-green/5 hover:text-summit-green hover:cursor-pointer",
        secondary:
